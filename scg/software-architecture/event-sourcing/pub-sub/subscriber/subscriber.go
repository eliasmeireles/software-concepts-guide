...
import (
	...
	pubsub "github.com/eliasmeireles/software-concepts-guide/software-architecture/event-sourcing/pub-sub"
	"log"
	"time"
)

var totalProcessedMessages int64 = 0
...
func HandleMessage(message pubsub.Message) {
	...
	log.Printf("New message processing: %v -> total messages processed: %d", message, totalProcessedMessages)
}
